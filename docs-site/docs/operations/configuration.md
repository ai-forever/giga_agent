---
title: "Конфигурация"
description: "Переменные окружения и значения по умолчанию GigaAgent."
---

# Конфигурация

Названия переменных оставлены без перевода, потому что они используются в командах и файлах окружения.
