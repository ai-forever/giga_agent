...
`giga_agent dev` loads 12 modules: `AuthModule`, `ReplModule`, `ImageModule`, `AnalyzeImagesModule`, `ScraperModule`, `SearchModule`, `RagModule`, `MemZeroModule`, `GitHubModule`, `VKModule`, `WeatherModule`, and `SubAgentLegacyModule`.
