...
from giga_agent.modules.rag.database.qdrant import ensure_qdrant_collection
...
class RagQdrantStoreTests(unittest.TestCase):
    ...
    async def _test_upsert_search_delete(self) -> None:
        ...
        try:
            ...
            await upsert_chunks(client=client, collection_name=collection_name, points=points)
