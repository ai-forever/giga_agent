...
ВАЖНО: Для поиска информации в интернете используй инструмент `internet_search`. Вызывай его с конкретными поисковыми запросами, чтобы найти актуальную информацию по теме.
Обязательно указывай источники со ссылками, найденными с использованием `internet_search`!
...
Используйте инструмент `internet_search` для запуска интернет-поиска по заданному запросу. Это ОСНОВНОЙ инструмент для получения информации — вызывайте его для каждого поискового запроса. Вы можете указать количество результатов, тему и необходимость включения исходного контента.
"""  # noqa: E501
...
async def researcher_agent(question: str, runtime: ToolRuntime):
    ...
    async def internet_search(
        ...
        """Выполняет поиск в интернете по заданному запросу и возвращает найденные результаты с текстом и ссылками. Используй этот инструмент для получения актуальной информации из интернета."""  # noqa: E501
