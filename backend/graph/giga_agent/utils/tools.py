#
# Эти функции перенесены is langchain.tools они нужны, чтобы вставлять Runtime, State,
# Store в вызов тула. Пока это часть достаточно грязного хака, когда мы тулы вызываем
# вне ToolNode.
#
